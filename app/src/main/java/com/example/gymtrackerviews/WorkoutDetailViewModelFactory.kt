package com.example.gymtrackerviews // O el paquete donde esté tu factory
...
// Asegúrate de que el nombre de la clase es WorkoutDetailViewModelFactory
class WorkoutDetailViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        throw IllegalArgumentException("Unknown ViewModel class for WorkoutDetail")
    }
}
